...
var myLineChart3 = new Chart(ctx3, {
  ...
  data: {
    ...
    datasets: [{
      ...
      data: [3, 15, 3, 0, 3, 0, 6, 5, 2, 4, 9, 2, 9, 14, 4, 0, 12, 3, 1, 14, 8, 9, 7, 1, 0, 0, 31, 20, 10, 6, 12, 15, 14, 14, 8, 8, 14, 14, 13, 22, 27, 24, 12, 20, 13, 26, 25, 14, 27, 24, 0, 0, -1, 0, 39, 13, 25, 18, 13, 0, -12, 12, 86, 28, 93, 96, 101, 92, 52, 10, 77, 80, 50, 27, 45, 60, 51, 32, 41, 18, 9, 9, 0, 85, 123, 48, 49, 36, 39, 73, 0, 83, 126, 32, 39, 42, 0, 100, 91, 65, 49, 42, 52, 60, 313, -202, 49, 42, 36, 2, 105, 38
      ],
    }],
  },
  options: {
...
var myLineChart4 = new Chart(ctx4, {
  ...
  data: {
    ...
    datasets: [{
      ...
      data: [1, 1, 1, 0, 1, 1, 0, 2, 0, 0, 1, 3, 0, 2, 2, 0, 0, 2, 1, 2, 2, 1, 1, 1, 3, 0, 6, 5, 2, 1, 4, 3, 5, 2, 0, 5, 2, 2, 2, 2, 4, 1, 2, 1, 6, 4, 6, 5, 8, 6, 3, 5, 5, 3, 5, 7, 5, 9, 6, 2, 1, 11, 8, 7, 2, 6, 9, 6, 12, 8, 5, 6, 12, 4, 4, 14, 10, 6, 7, 6, 1, 4, 10, 4, 1, 13, 8, 6, 4, 8, 15, 11, 7, 6, 7, 1, 10, 8, 1, 9, 5, 5, 2, 5, 5, 3, 7, 7, 2, 4, 3
      ],
    }],
  },
  options: {
...
var myLineChart5 = new Chart(ctx5, {
  ...
  data: {
    ...
    datasets: [{
      ...
      data: [12, 5, 4, 6, 6, 4, 9, 12, 10, 14, 11, 3, 3, 14, 15, 8, 18, 22, 7, 11, 13, 20, 11, 12, 21, 7, 24, 23, 20, 18, 26, 14, 18, 16, 20, 25, 37, 22, 34, 13, 23, 22, 25, 29, 58, 65, 20, 8, 64, 55, 34, 64, 40, 55, 20, 25, 90, 65, 98, 72, 29, 25, 86, 54, 37, 34, 59, 39, 45, 37, 42, 39, 64, 50, 46, 91, 55, 51, 51, 62, 79, 24, 46, 75, 55, 141, 65, 66, 60, 45, 35, 98, 50, 50, 71, 43, 31, 49, 58, 49, 47, 30, 3, 5, 53, 45, 50, 36, 36, 11, 42],
    }],
  },
  options: {
    maintainAspectRatio: false,
